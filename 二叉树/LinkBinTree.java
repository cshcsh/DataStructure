...
public class LinkBinTree<T> {
	...
	public static void main(String[] args) {
		...
		LinkBinTree<String> binTree = new LinkBinTree<String>("根");

		LinkBinTree.TreeNode node1 = binTree.addNode(binTree.getRoot(), "根左", true);
		LinkBinTree.TreeNode node2 = binTree.addNode(binTree.getRoot(), "根右", false);
		LinkBinTree.TreeNode node3 = binTree.addNode(node2, "根右左", true);
		LinkBinTree.TreeNode node4 = binTree.addNode(node2, "根右右", false);
		LinkBinTree.TreeNode node5 = binTree.addNode(node4, "根右右左", true);
		LinkBinTree.TreeNode node6 = binTree.addNode(node3, "根右左右", false);
		LinkBinTree.TreeNode node7 = binTree.addNode(node6, "根右左右右", false);
